...
repo="https://raw.githubusercontent.com/sukronwae85-design/SUKRONWAE85/main/"
...
data_ip="https://raw.githubusercontent.com/sukronwae85-design/SUKRONWAE85/main/ip"
checking_sc() {
...
clear
cd
wget -q -O /usr/local/sbin/quota "https://raw.githubusercontent.com/sukronwae85-design/SUKRONWAE85/main/limit/quota"
chmod +x /usr/local/sbin/quota
cd /usr/local/sbin/
sed -i 's/\r//' quota
clear
cd
wget -q -O /usr/bin/limit-ip "https://raw.githubusercontent.com/sukronwae85-design/SUKRONWAE85/main/limit/limit-ip"
chmod +x /usr/bin/*
cd /usr/bin
sed -i 's/\r//' limit-ip
clear
wget -q -O /usr/bin/limit-ip-ssh "https://raw.githubusercontent.com/sukronwae85-design/SUKRONWAE85/main/limit/limit/limit-ip-ssh"
chmod +x /usr/bin/*
cd /usr/bin
...
wget -q -O /usr/local/bin/ws-ovpn https://raw.githubusercontent.com/sukronwae85-design/SUKRONWAE85/main/ws/ws-ovpn.py
...
insbkp() {
wget -q https://raw.githubusercontent.com/sukronwae85-design/SUKRONWAE85/main/limit/installbckp.sh && chmod +x installbckp.sh && ./installbckp.sh
clear
}
...
insdns() {
#wget https://raw.githubusercontent.com/sukronwae85-design/SUKRONWAE85/main/slow/installsl.sh && chmod +x installsl.sh && bash installsl.sh
clear
}

instm() {
wget -q https://raw.githubusercontent.com/sukronwae85-design/SUKRONWAE85/main/xray/tm.sh && chmod +x tm.sh && ./tm.sh
clear
}

insmenu() {
wget -q https://raw.githubusercontent.com/sukronwae85-design/SUKRONWAE85/main/xray/up.sh && chmod +x up.sh && ./up.sh
clear
}
...
USRID=$(curl https://raw.githubusercontent.com/sukronwae85-design/SUKRONWAE85/main/ip | grep $ipsaya | awk '{print $2}')
USREXP=$(curl https://raw.githubusercontent.com/sukronwae85-design/SUKRONWAE85/main/ip | grep $ipsaya | awk '{print $3}')
TIME=`date -d "0 days" +"%d-%m-%Y" `
TIMEZONE=$(printf '%(%H:%M:%S)T')
TEXT="
<code>────────────────────</code>
<b>⚠️AUTOSCRIPT JULAK BANTUR C01⚠️</b>
<code>────────────────────</code>
