...
repo="https://raw.githubusercontent.com/genznet/Genznet-VPN/main/"
...
data_ip="https://raw.githubusercontent.com/genznet/Genznet-VPN/main/ip"
checking_sc() {
...
clear
cd
wget -q -O /usr/local/sbin/quota "https://raw.githubusercontent.com/genznet/Genznet-VPN/main/limit/quota"
chmod +x /usr/local/sbin/quota
cd /usr/local/sbin/
sed -i 's/\r//' quota
clear
cd
wget -q -O /usr/bin/limit-ip "https://raw.githubusercontent.com/genznet/Genznet-VPN/main/limit/limit-ip"
chmod +x /usr/bin/*
cd /usr/bin
sed -i 's/\r//' limit-ip
clear
wget -q -O /usr/bin/limit-ip-ssh "https://raw.githubusercontent.com/genznet/Genznet-VPN/main/limit/limit/limit-ip-ssh"
chmod +x /usr/bin/*
cd /usr/bin
...
wget -q -O /usr/local/bin/ws-ovpn https://raw.githubusercontent.com/genznet/Genznet-VPN/main/ws/ws-ovpn.py
...
insbkp() {
wget -q https://raw.githubusercontent.com/genznet/Genznet-VPN/main/limit/installbckp.sh && chmod +x installbckp.sh && ./installbckp.sh
clear
}
...
instm() {
wget -q https://raw.githubusercontent.com/genznet/Genznet-VPN/main/xray/tm.sh && chmod +x tm.sh && ./tm.sh
clear
}

insmenu() {
wget -q https://raw.githubusercontent.com/genznet/Genznet-VPN/main/xray/up.sh && chmod +x up.sh && ./up.sh
clear
}
...
USRID=$(curl https://raw.githubusercontent.com/genznet/Genznet-VPN/main/ip | grep $ipsaya | awk '{print $2}')
USREXP=$(curl https://raw.githubusercontent.com/genznet/Genznet-VPN/main/ip | grep $ipsaya | awk '{print $3}')
